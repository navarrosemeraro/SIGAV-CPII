        ...
        <div id="center-form" class="container min-vh-100 d-flex justify-content-center" style="margin-top: 30px;">
                <form action="../../assets/php/cadastro-e-login/cadastro-usuario.php" method="post">
                    <div
                        ...
                        <label for="materias">Função:</label>
                        <select class="form-select" id="funcao" name="funcao">
                            <option value="corretores">Docente</option>
                            <option value="alunos">Discente(Aluno)</option>
                        </select>
                    </div>
                    <fieldset style="border: 2px black solid; padding: 30px; width: 800px;">
                        ...
                        <div id="espec-aluno"></div>
                        <div class="mb-2">
                            <b><label for="senha" class="form-label">Senha:</label></b>
                        ...
                        <button type="submit" id="btn_cadastro" class="btn btn-outline-primary">Finalizar Cadastro</button></a>
                    </fieldset>
                </form>
        </div>
    </section>
