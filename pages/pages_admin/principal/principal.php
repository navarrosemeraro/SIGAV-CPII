...
<head>
    ...
    <link rel="stylesheet" href="../../../assets/admin/css/pages/principal/principal.css">
    <link rel="icon" type="image/png" href="../../../assets/admin/img/global/Brasão_Colégio_Pedro_II.png">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" style="margin-left: 10px;">SIGAV CPII<span><img
                        src="../../../assets/admin/img/global/Brasão_Colégio_Pedro_II.png" alt="Brasão Colégio PedroII"
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../correcao/corrigir_redacao.html">Corrigir</a></li>
                            <li><a class="dropdown-item" href="../consulta/banco_redacoes.html">Banco de Redações</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../inserir_nov/inserir_cartoes.html">Inserir Novo(s) na
                                    Base de Dados</a></li>
                            <li><a class="dropdown-item" href="../consulta/banco_cartoes.html">Banco de Cartões</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" style="width: 50%;">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="../../../assets/admin/img/pages/principal/ENEM/caderno-questoes.png" class="d-block w-100"
                            alt="Caderno de Questões">
                    </div>
                    <div class="carousel-item">
                        <img src="../../../assets/admin/img/pages/principal/ENEM/folha-red.png" class="d-block w-100"
                            alt="Folha de Redação">
                    </div>
                    <div class="carousel-item">
                        <img src="../../../assets/admin/img/pages/principal/ENEM/cartao-resposta.png" class="d-block w-100"
                            alt="Cartão Resposta">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="card h-100">
                        <img src="../../../assets/admin/img/pages/principal/Devs/bruno-foto.jpeg" class="card-img-top"
                ...
                <div class="col-6 col-md-3">
                    <div class="card h-100">
                        <img src="../../../assets/admin/img/pages/principal/Devs/giovanni-foto.jpeg" class="card-img-top"
                ...
                <div class="col-6 col-md-3">
                    <div class="card h-100">
                        <img src="../../../assets/admin/img/pages/principal/Devs/otto-foto.jpeg" class="card-img-top"
                ...
                <div class="col-6 col-md-3">
                    <div class="card h-100">
                        <img src="../../../assets/admin/img/pages/principal/Devs/Lucia-Deborah-Araujo.png" class="card-img-top"
                            alt="Desenvolvedor Professora Lúcia Deborah">
                        <div class="card-body">
