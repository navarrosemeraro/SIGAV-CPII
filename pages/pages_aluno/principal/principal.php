        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div id="barra_usuario">
                    <a style="margin-right: 20px; margin-top: 0; color:rgba(0, 0, 0, 1); text-decoration:none;" href="../perfil_aluno/perfil_aluno.html" class="dropdown-toggle">
                        <span>
            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="card h-100">
                        <img src="../../../assets/aluno/img/pages/principal/Devs/bruno-foto.jpeg" class="card-img-top"
                ...
                <div class="col-6 col-md-3">
                    <div class="card h-100">
                        <img src="../../../assets/aluno/img/pages/principal/Devs/otto-foto.jpeg" class="card-img-top"
                ...
                <div class="col-6 col-md-3">
                    <div class="card h-100">
                        <img src="../../../assets/aluno/img/pages/principal/Devs/Lucia-Deborah-Araujo.png"
