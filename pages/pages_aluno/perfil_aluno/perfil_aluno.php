...
<body>
    ...
    <div style="display: flex; align-items: center; width: 100%; height: 100%; Top: 50%">
        <div class="container" id="profile">
            ...
            <div id="link-retorno">
                <a href="../area_aluno/area_aluno.php">
                ...
                <h5 style="margin-left: 15px;"><a href="../area_aluno/area_aluno.php" style=" text-decoration:none; color:#143c2c;">Retornar à Área do Aluno</a></h5>
            </div>
        </div>
    </div>
    </section>
