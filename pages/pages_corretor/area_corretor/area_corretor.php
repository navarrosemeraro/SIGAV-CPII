    ...
    <main>
        <section id="um">
            <div style="display: flex; justify-content: center; align-items: center; margin-top: 30px;">
                ...
                <svg style="position: relative; top: 50%;" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
            ...
            <div class="container-xxl" style="display: flex; justify-content: center;">
                <div class="card"
                    style="width: 30rem; margin-top: 60px; box-shadow: 0px 5px 10px rgba(160, 130, 200, 1)">
                    <div class="card-body">
                        <h3 class="card-title">Corrigir Redações</h3>
                        <p class="card-text" style="font-size: 17px;">Corrigir Redações Pendentes de Alunos</p>
                        <a id="btn1" href="../correcao/selecionar_redacao.php" class="btn btn-primary">Selecionar
                            Redação</a>
                        <svg style="position: relative; left: 45%; color:rgba(160, 130, 200, 1);"
                        ...
                        <div class="col">
                            <div class="card"
                                ...
                                <div class="card-body" style="text-align: left;">
                                    ...
                                    <p class="card-text" style="font-size: 17px;">Rever ou Revisar Redações já
                                        corrigidas</p>
                                    <a id="btn2" href="../consulta/banco_redacoes.php" class="btn btn-primary">Ver
                                        Redações</a>
                        ...
                        <div class="col">
                            <div class="card"
                                ...
                                <div class="card-body" style="text-align: left;">
                                    ...
                                    <p class="card-text" style="font-size: 17px;">Inserir Novas Redações no Banco de
                                        Dados, a fim de serem corrigidas depois</p>
                                    <a id="btn3" href="../consulta/inserir_redacoes.php" class="btn btn-primary">Inserir
                                        redações</a>
                                    <svg style="position: relative; left: 43%; width: 60px; height: 60px; color:rgba(67, 185, 150, 1);"
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
