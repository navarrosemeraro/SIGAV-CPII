    ...
    <main style="margin-top: 50px;">
        <section id="um">
            ...
            <div class="container d-flex flex-column flex-md-row justify-content-between align-items-start gap-4"
                id="div-correcao">
                <div id="resultado_consulta" class="w-100 w-md-auto" style="flex: 2; height:1000px">
                        ...
                        <form action="../../../php/corretor/correcao/enviar_redacao_corrigida.php" method="POST">
                            <div style="display: flex; gap: 200px; align-items:last baseline; justify-content: center;">
                                <div class="container text-center">
                                    <div class="row">
                                        <div class="col d-flex flex-column flex-md-row gap-4"
                                            style="padding: 0; align-items:start;">
                                            ...
                                            <div style="float:right; width:100%;">
                                                <label style="font-size:16px; text-align:left;"><b>Demonstrar domínio da
                                                        norma culta da língua portuguesa</b></label><br><br>
                                                <div class="progress" role="progressbar" aria-label="Basic example"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"
                                                    data-nota="<?= $row['nota_comp1']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col d-flex flex-column flex-md-row gap-4"
                                            ...
                                            <div style="float:right; width:100%;">
                                                <label style="font-size:16px; text-align:left;"><b>Compreender proposta
                                                        e aplicar diferentes conhecimentos</b></label><br><br>
                                                <div class="progress" role="progressbar" aria-label="Basic example"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"
                                                    data-nota="<?= $row['nota_comp2']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col d-flex flex-column flex-md-row gap-4"
                                            ...
                                            <div style="float:right; width:100%;">
                                                <label style="font-size:16px; text-align:left;"><b>Organização e clareza
                                                        da argumentação</b></label><br><br>
                                                <div class="progress" role="progressbar" aria-label="Basic example"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"
                                                    data-nota="<?= $row['nota_comp3']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col d-flex flex-column flex-md-row gap-4"
                                            ...
                                            <div style="float:right; width:100%;">
                                                <label style="font-size:16px; text-align:left;"><b>Demonstrar
                                                        conhecimento dos mecanismos linguísticos</b></label><br><br>
                                                <div class="progress" role="progressbar" aria-label="Basic example"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"
                                                    data-nota="<?= $row['nota_comp4']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col d-flex flex-column flex-md-row gap-4"
                                            ...
                                            <div style="float:right; width:100%;">
                                                <label style="font-size:16px; text-align:left;"><b>Proposta de solução
                                                        para o problema abordado</b></label><br><br>
                                                <div class="progress" role="progressbar" aria-label="Basic example"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"
                                                    data-nota="<?= $row['nota_comp5']; ?>">
                                        ...
                                        <div class="col d-flex flex-column flex-md-row gap-4"
                                            ...
                                            <div style="float:left;">
                                                <div id="div_nota">
                                                    ...
                                                    <label
                                                        style="margin-left: 5px; padding:4px; border: 1px white solid">
                                                        <?php echo $row["nota_total"]; ?>
                                                    </label>
                                                </div>
