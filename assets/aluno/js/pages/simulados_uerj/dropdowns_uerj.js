            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col">
                        ...
                        <a target="_blank" href="../../../assets/aluno/pdf/simulados_cp2/UERJ/2025/1º SIMULADO UERJ 2025.pdf"><p>Prova</p></a>
                        <a target="_blank" href="../../../assets/aluno/pdf/simulados_cp2/UERJ/2025/GABARITO -  1º SIMULADO UERJ 2025.pdf"><p>Gabarito</p></a>
                    </div>
                    <div class="col">
                        <p style="opacity: 0.5;">2º Simulado (18/08)</p>
                        <a target="_blank" href="#"><p>Prova</p></a>
                        <a target="_blank" href="#"><p>Gabarito</p></a>
                    </div>
                </div>
            </div>
        </div>`;
    ...
    if (c2024 == 0) {
        p_g.innerHTML = `<div style="width: 100%; height: auto; background-color: blanchedalmond; border-radius: 10px; border: solid 1px #2d543d;
            border-top: none; padding: 10px;">
                ...
                <a target="_blank" href="../../../assets/aluno/pdf/simulados_cp2/UERJ/2024/1º SIMULADO UERJ 2024.pdf"><p>Prova</p></a>
                <a target="_blank" href="../../../assets/aluno/pdf/simulados_cp2/UERJ/2024/GABARITO - 1º SIMULADO UERJ 2024.pdf"><p>Gabarito</p></a>
            </div>`;
        c2024++;
    }
    else {
